...
- 🔭 My development focus is ```Data Science``` and ```Machine Learning```.
- 🌱 Currently learning ```Python```.
- 🎓 I'm pursuing a Bachelor's degree in Software Engineering at the University [Católica SC](https://www.catolicasc.org.br/).
